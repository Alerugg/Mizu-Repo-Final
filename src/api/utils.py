...
def generate_sitemap(app):
    ...
    links_html = "".join([f"<li style='padding: 10px 0 5px 0;'><a style='text-decoration: none; color: black; text-transform: uppercase;' href='{url}' onmouseover='this.style.color=\"darkred\"' onmouseout='this.style.color=\"black\"' onclick='this.style.color=\"blue\"'>{url}</a></li>" for url in unique_endpoints])
    ...
    additional_data_html = """
        ...
        <div style=\"text-align: left; padding: 40px; margin: 20px 100px; background-color: #333; border-radius: 10px; color: white;\">
            ...
            <p><strong>path request:</strong> /services</p>
        ...
        <body style=\"background-color: white; color: black; text-align: center; font-family: 'Montserrat', arial;\">
            <div style=\"text-align: center;\">
                <div style=\"position: fixed; bottom: 0; right: 0; margin: 40px;\">
                    <button style=\"font-family: 'Montserrat'; border-radius: 40px; background-color: grey; padding: 20px; box-shadow: 0px 0px 10px 0px white; transition: all 0.3s ease;\"
